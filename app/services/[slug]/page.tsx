...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${service.metaTitle} | Michael Odugu`,
      description: service.metaDescription,
      type: "website",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${service.title} by Michael Odugu`,
        },
      ],
    },
    twitter: {
          ...
          <div className="mt-4 grid gap-6 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-xl text-sm leading-8 text-silver md:text-base">
                Send the current state of the project, what you want it to achieve, and your target launch date through the contact form.
              </p>
            </div>
            <TrackedLink
              href={siteConfig.contactHref}
              tracking={{ type: "contact_click", location: "service_detail_cta", label: service.title }}
